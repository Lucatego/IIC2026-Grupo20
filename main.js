...
fetch('Dataset/avg_viewers.json')
    ...
    .then(rows => {
        ...
        if (idx22Q1 !== -1 && idx22Q2 !== -1 && idx22Q3 !== -1 && idx22Q4 !== -1) {
            ...
            line: { width: 4, color: '#b858a3ff' }, // verde
            marker: {
        ...
        if (idx24Q1 !== -1 && idx24Q2 !== -1) {
            ...
            line: { width: 4, color: '#b858a3ff' }, // mismo verde
            marker: {
                size: [9, 9],
                color: '#b858a3ff',
                opacity: 1,
        ...
        chart.on('plotly_hover', function(data) {
            ...
            // Solo responder al hover en los tramos resaltados
            if (traceName === 'Fortnite') {
                ...
                // Ejemplo: gráfico comparativo de ese período
                const hoverPeriod = data.points[0].customdata; // Ejemplo: "2020-Q1"
                const miniData = [{
                    x: ['Twitch', 'YouTube', 'Kick'],
                    y: [80, 50, 20],
                    type: 'bar',
                    marker: { color: ['#a340f7', '#b858a3', '#0a0a0a'] }
                }];
                
                const miniLayout = {
                    title: `<b>Plataformas más vistas en ${hoverPeriod}</b>`,
        ...
        // Al salir del hover, ocultar el gráfico
        chart.on('plotly_unhover', function() {
            // TODO: Esto deberiamos cambiarlo?
